...
class FlowStep(BaseModel):
    ...
    def validate_step_name(cls, v):
        if not re.match(r'^[a-zA-Z0-9_]+$', v):
            raise ValueError('O nome do passo deve conter apenas letras, números e underscores')
        return v
...
class Flow(BaseModel):
    ...
    def validate_name(cls, v):
        if not re.match(r'^[a-zA-Z0-9_]+$', v):
            raise ValueError('O nome do fluxo deve conter apenas letras, números e underscores')
        return v
